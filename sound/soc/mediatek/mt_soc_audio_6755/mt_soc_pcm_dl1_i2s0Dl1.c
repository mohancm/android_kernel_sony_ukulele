...
static int mtk_pcm_I2S0dl1_close(struct snd_pcm_substream *substream)
{
	...
	//	if (mI2S0dl1_hdoutput_control == true) {//fix fm mclk can not close by oliverchen 20160316
			//pr_warn("%s mI2S0dl1_hdoutput_control == %d\n", __func__,
			//       mI2S0dl1_hdoutput_control);
			/* here to open APLL */
			//EnableI2SDivPower(AUDIO_APLL12_DIV2, false);//fix fm mclk close byoliverchen 20160316
			//EnableI2SDivPower(AUDIO_APLL12_DIV4, false);//fix fm mclk close byoliverchen 20160316
