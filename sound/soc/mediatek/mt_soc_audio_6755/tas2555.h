...
#define TAS2555_CLK_HALT_REG			TAS2555_REG(0, 1, 106)
...
#define TAS2555_ERROR_FWFORMAT		0x00000008//not failsafe
#define TAS2555_ERROR_RETOOHIGH		0x00000010
#define TAS2555_ERROR_RETOOLOW		0x00000020
#define TAS2555_ERROR_FWNOTLOAD		0x00000040//not failsafe
#define TAS2555_ERROR_INVALIDPARAM	0x00000080//not failsafe
#define TAS2555_ERROR_VALUENOTMATCH	0x01000000
#define TAS2555_ERROR_OVERTMP		0x02000000//not failsafe
#define TAS2555_ERROR_CLKPRESENT	0x04000000//not failsafe
#define TAS2555_ERROR_BROWNOUT		0x08000000//not failsafe
#define TAS2555_ERROR_UNDERVOLTAGET	0x10000000//not failsafe
#define TAS2555_ERROR_OVERCURRENT	0x20000000//not failsafe
