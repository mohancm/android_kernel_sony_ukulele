...
static struct snd_soc_dai_link mt_soc_dai_common[] = {
	 ...
	 },
	{
	 ...
	 .codec_dai_name = "tas2555 ASI1",//oliverchen add smartpa for voice speaker
     .codec_name = "tas2555.4-004c",//oliverchen add smartpa for voice speaker
     #else
	 ...
	 },
	{
	 ...
	 #ifdef CONFIG_SND_SOC_TAS2555
	 .codec_dai_name = "tas2555 ASI1",//oliverchen add smartpa for playback
     .codec_name = "tas2555.4-004c",//oliverchen add smartpa for playback
	 #else
	 ...
	 },
	{
	 ...
	 .platform_name = MT_SOC_FM_I2S_PCM,
	  #ifdef CONFIG_SND_SOC_TAS2555
	 .codec_dai_name = "tas2555 ASI1",//oliverchen add smartpa for fm speaker
     .codec_name = "tas2555.4-004c",//oliverchen add smartpa for fm speakers
	  #else
	 ...
	 },
	{
	 ...
	 #ifdef CONFIG_SND_SOC_TAS2555
     .codec_dai_name = "tas2555 ASI1",//oliverchen add smartpa for fastplayback
     .codec_name = "tas2555.4-004c",//oliverchen add smartpa for fast playback
     #else
