 ...
 */
 ...
 struct snd_soc_pcm_runtime *rtd_speaker_control;//fix speaker and headset playback at the same time by oliverchen 
 #endif
static int soc_pcm_prepare(struct snd_pcm_substream *substream)
{
	...
	#ifdef CONFIG_SND_SOC_TAS2555
	rtd_speaker_control = rtd;//fix speaker and headset playback at the same time by oliverchen
	#endif
    #endif
	mutex_lock_nested(&rtd->pcm_mutex, rtd->pcm_subclass);
...
//#ifndef CONFIG_SND_SOC_TAS2555 //TI smart pa tas2555 remove DAPM by oliverchen
