...
/*[SM20][zihweishen] For read status of GPIO 20160223 begin*/
#include <linux/of.h>
#include <linux/of_irq.h>
#include <linux/of_address.h>
#include <linux/gpio.h>
/*[SM20][zihweishen] 20160223 end*/

#include "mt_boot_common.h"

#include "tpd.h"

/*[Lavender][bozhi_lin] touch check product id to distinguish dp and sp sample 20150402 begin*/
#define TP_HARDWARE_CHECK
/*[Lavender][bozhi_lin] 20150402 end*/

/*[SM20][zihweishen] upgrade synaptics touch Truly PQ2 firmware to 0x0101000B 2016/6/08 begin*/
/*[SM20][zihweishen] upgrade synaptics touch INNX firmware for PQ build 2016/5/04 begin*/
/*[SM20][zihweishen] upgrade synaptics touch INNX SP to AP2 firmware 2016/4/22 begin*/
/*[SM20][zihweishen] upgrade synaptics touch Truly AP2 firmware to 0x01010003 2016/4/21 begin*/
/*[SM20][zihweishen] upgrade synaptics touch INNX SP to AP2 firmware 2016/4/14 begin*/
/*[SM20][zihweishen] Add synaptics touch AP2 Truly firmware to 0x01010002 20160411 begin*/
/*[SM20][zihweishen] To distinguish synaptics touch firmware for DP SP AP1 AP2 20160330 begin*/
/*[SM20][zihweishen] To distinguish synaptics touch firmware for DP SP AP 20160223 begin*/
/*[SM20][zihweishen] upgrade synaptics touch SP firmware to 0x00020003 20160219 begin*/
/*[SM20][zihweishen] upgrade synaptics touch SP firmware to 0x00010005 20160215 begin*/
/*[SM20][zihweishen] upgrade synaptics touch SP firmware to 0x00010004 20160202 begin*/
/*[SM20][zihweishen] upgrade synaptics touch DP firmware to 0x00010002 20151130 begin*/
/*[Lavender][bozhi_lin] upgrade synaptics touch AP firmware to 0x00040010 20150930 begin*/

#if defined(TP_HARDWARE_CHECK)
#define FW_IMAGE_NAME_DP_SP "PD060IC-05B_DS5V4.4.1.1004_PR2357073_00010007.img"
#define FW_IMAGE_NAME_AP1 "PD060IC-05B_DS5V4.4.1.1004_PR2357073_00020005.img"
#define FW_IMAGE_NAME_AP2 "PD060IC-05B_DS5V4.4.1.1004_PR2357073_00030003.img"
#define FW_IMAGE_NAME_PQ "PD060IC-05B_DS5V4.4.1.1004_PR2357073_00040002.img"
#define FW_IMAGE_NAME_Truly_AP2 "PR2387340-s2726br_0531_1_0101000B.img"


#define FW_IMAGE_NAME_I53_AP "PD060SC-04A_DS5V4.4.1.25_PR1898977_00040010_Unlocked.img"
#else
#define FW_IMAGE_NAME "synaptics/startup_fw_update.img"
#endif

/*[Lavender][bozhi_lin] 20150930 end*/
/*[SM20][zihweishen] 20151130 end*/
/*[SM20][zihweishen] 20160202 end*/
/*[SM20][zihweishen] 20160215 end*/
/*[SM20][zihweishen] 20160219 end*/
/*[SM20][zihweishen] 20160223 end*/
/*[SM20][zihweishen] 20160330 end*/
/*[SM20][zihweishen] 20160411 end*/
/*[SM20][zihweishen] 20160414 end*/
/*[SM20][zihweishen] 20160421 end*/
/*[SM20][zihweishen] 20160422 end*/
/*[SM20][zihweishen] 20160504 end*/
/*[SM20][zihweishen] 20160608 end*/
...
enum tp_hw_run {
	...
	SYNAPTICS_DP = 1, //DP
	SYNAPTICS_SP = 2, //SP
	SYNAPTICS_I53_AP = 3, //AP2-I53 L
	SYNAPTICS_AP1 = 4, //AP1
	SYNAPTICS_AP2 = 5, //AP2
	SYNAPTICS_Truly_AP2 = 6, //AP2-SM20TY
	SYNAPTICS_PQ = 7, //PQ
...
static struct device_attribute attrs[] = {
	__ATTR(doreflash, 0640,
			synaptics_rmi4_show_error,
			fwu_sysfs_do_reflash_store),
	__ATTR(writeconfig, 0640,
			synaptics_rmi4_show_error,
			fwu_sysfs_write_config_store),
	__ATTR(readconfig, 0640,
			synaptics_rmi4_show_error,
			fwu_sysfs_read_config_store),
	__ATTR(configarea, 0640,
			synaptics_rmi4_show_error,
			fwu_sysfs_config_area_store),
	__ATTR(imagename, 0640,
			synaptics_rmi4_show_error,
			fwu_sysfs_image_name_store),
	__ATTR(imagesize, 0640,
			synaptics_rmi4_show_error,
...
/*[SM20][zihweishen] To distinguish synaptics touch firmware for DP SP AP 20160223 begin*/
#if defined(TP_HARDWARE_CHECK)
static int mt_get_dp_gpio_value(int gpio_num)
{
	int value = 0;
...
static int fwu_wait_for_idle(int timeout_ms)
{
	...
	do {
		...
		count++;
/*[Lavender][bozhi_lin] fix touch firmware upgrade un-stable 20150304 begin*/
#if 1
		if ((count % 10) == 0) {
			fwu_read_f34_flash_status();
			pr_err("[B]%s(%d): fwu_read_f34_flash_status, count=%d\n", __func__, __LINE__, count);
		}
#else		
...
/*[SM20][zihweishen] Firmware update for testing number of version 20160126 begin*/
/*[Lavender][bozhi_lin] touch check product id to distinguish dp and sp sample 20150402 begin*/
#if 0
...
/*[Lavender][bozhi_lin] 20150402 end*/
	...
	dev_info(&fwu->rmi4_data->i2c_client->dev,
			...
			fwu->config_data[2],
			fwu->config_data[3]);
/*[Lavender][bozhi_lin] enable firmware upgrade by check version 20150714 begin*/
/*[Lavender][bozhi_lin] upgrade touch firmware from 0x00010003 to 0x00010004 and force upgrade to 0x00010004 20150401 begin*/
#if 0
...
#endif
/*[Lavender][bozhi_lin] 20150401 end*/
/*[Lavender][bozhi_lin] 20150714 end*/
/*[SM20][zihweishen] 20160330 end*/
...
static int fwu_start_reflash(void)
{
	...
	struct f01_device_status f01_device_status;
	const unsigned char *fw_image;
/*[SM20][zihweishen] Get device config ID 20160411 begin*/
	unsigned char config_id[4];
	unsigned int device_config_id;
	const struct firmware *fw_entry = NULL;
/*[Lavender][bozhi_lin] touch check product id to distinguish dp and sp sample 20150402 begin*/
#if defined(TP_HARDWARE_CHECK)
	enum tp_hw_run tp_hw_run = SYNAPTICS_NONE;
#endif
/*[Lavender][bozhi_lin] 20150402 end*/
...
/*[Lavender][bozhi_lin] only enable touch sp & ap can do auto-upgrade 20150519 begin*/
/*[Lavender][bozhi_lin] force enable auto-upgrade firmware with SP build 20150518 begin*/
/*[Lavender][bozhi_lin] only synaptics touch AP can do auto-upgrade firmware 20150515 begin*/
/*[Lavender][bozhi_lin] add check touch ap2 product id to only ap2 can enable glove mode 20150513 begin*/
/*[Lavender][bozhi_lin] touch check product id to distinguish dp and sp sample 20150402 begin*/
#if defined(TP_HARDWARE_CHECK)
#if 1
	if (!strncmp(fwu->product_id, "I53LV3", 6)) {
		printk("[B]%s(%d): fwu->product_id=%s, is AP2 run\n", __func__, __LINE__, fwu->product_id);
		tp_hw_run = SYNAPTICS_I53_AP;
	}
...
/*[SM20][zihweishen] To distinguish synaptics touch firmware for DP SP AP1 AP2 20160330 begin*/
/*[SM20][zihweishen] To distinguish synaptics touch firmware for DP SP AP 20160223 begin*/
/*[SM20][zihweishen] enable firmware upgrade by check version 20151130 begin*/
/*[Lavender][bozhi_lin] enable firmware upgrade by check version 20150714 begin*/

	else if ((mt_get_dp_gpio_value(13)==0) && (mt_get_dp_gpio_value(14)==0)) {
		printk("[B]%s(%d): fwu->product_id=%s, is DP run\n", __func__, __LINE__, fwu->product_id);
		printk("zihwei GPIO13=%x\n",mt_get_dp_gpio_value(13));
		printk("zihwei GPIO14=%x\n",mt_get_dp_gpio_value(14));
		tp_hw_run = SYNAPTICS_DP;
	}
	else if ((mt_get_dp_gpio_value(13)==0) && (mt_get_dp_gpio_value(14)==1)) {
		if (config_id[1] == 1) {
				printk("[B]%s(%d): fwu->product_id=%s, is SP run\n", __func__, __LINE__, fwu->product_id);
				printk("zihwei GPIO13=%x\n",mt_get_dp_gpio_value(13));
				printk("zihwei GPIO14=%x\n",mt_get_dp_gpio_value(14));	
				tp_hw_run = SYNAPTICS_SP;
			}
				else{
				printk("[B]%s(%d): fwu->product_id=%s, is AP1 run\n", __func__, __LINE__, fwu->product_id);
				printk("zihwei GPIO13=%x\n",mt_get_dp_gpio_value(13));
				printk("zihwei GPIO14=%x\n",mt_get_dp_gpio_value(14));
				tp_hw_run = SYNAPTICS_AP1;
			}

	}
	else if (!strncmp(fwu->product_id, "SM20PQ", 6)) {
		printk("[B]%s(%d): fwu->product_id=%s, is INNX PQ run\n", __func__, __LINE__, fwu->product_id);
		printk("zihwei GPIO13=%x\n",mt_get_dp_gpio_value(13));
		printk("zihwei GPIO14=%x\n",mt_get_dp_gpio_value(14));
		//if (mt_get_dp_gpio_value(14)==0) 
		tp_hw_run = SYNAPTICS_PQ;
	}
	else if (!strncmp(fwu->product_id, "SM20AP", 6)) {
		printk("[B]%s(%d): fwu->product_id=%s, is AP2 run\n", __func__, __LINE__, fwu->product_id);
		printk("zihwei GPIO13=%x\n",mt_get_dp_gpio_value(13));
		printk("zihwei GPIO14=%x\n",mt_get_dp_gpio_value(14));
		//if (mt_get_dp_gpio_value(14)==0) 
		tp_hw_run = SYNAPTICS_AP2;
	}
	else if (!strncmp(fwu->product_id, "SM20TY", 6)) {
		printk("[B]%s(%d): fwu->product_id=%s, is Truly PQ2 run\n", __func__, __LINE__, fwu->product_id);
		printk("zihwei GPIO13=%x\n",mt_get_dp_gpio_value(13));
		printk("zihwei GPIO14=%x\n",mt_get_dp_gpio_value(14));
		//if (mt_get_dp_gpio_value(14)==0) 
		tp_hw_run = SYNAPTICS_Truly_AP2;
	}
...
/*[SM20][zihweishen] 20160504 end*/
		...
		printk("[B]%s(%d): fwu->product_id=%s, is not AP2 run\n", __func__, __LINE__, fwu->product_id);
		tp_hw_run = SYNAPTICS_NONE;
		printk("zihwei GPIO13=%x\n",mt_get_dp_gpio_value(13));
		printk("zihwei GPIO14=%x\n",mt_get_dp_gpio_value(14));
	}
#else
	if ( (!strncmp(fwu->product_id, "s2726", 5)) || (!strncmp(fwu->product_id, "S2726", 5))) {
		printk("[B]%s(%d): fwu->product_id=%s, is DP1 or DP2 run\n", __func__, __LINE__, fwu->product_id);
		tp_hw_run = SYNAPTICS_DP;
	}
	else if (!strncmp(fwu->product_id, "I53LV2", 6)) {
		printk("[B]%s(%d): fwu->product_id=%s, is SP or AP1 run\n", __func__, __LINE__, fwu->product_id);
		tp_hw_run = SYNAPTICS_SP;
	}
	else {
		printk("[B]%s(%d): fwu->product_id=%s, is AP2 run\n", __func__, __LINE__, fwu->product_id);
		tp_hw_run = SYNAPTICS_AP;
	}
#endif
#endif
/*[Lavender][bozhi_lin] 20150402 end*/
/*[Lavender][bozhi_lin] 20150513 end*/
/*[Lavender][bozhi_lin] 20150515 end*/
/*[Lavender][bozhi_lin] 20150518 end*/
/*[Lavender][bozhi_lin] 20150519 end*/
/*[SM20][zihweishen] 20160330 end*/
...
#if defined(TP_HARDWARE_CHECK)
#if 1
		if (tp_hw_run >= SYNAPTICS_PQ) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_PQ, MAX_IMAGE_NAME_LEN);
		}
/*[SM20][zihweishen] To distinguish synaptics touch firmware for DP SP AP 20160223 begin*/
/*[SM20][zihweishen] enable firmware upgrade by check version 20151130 begin*/
/*[Lavender][bozhi_lin] enable firmware upgrade by check version 20150714 begin*/
		else if (tp_hw_run >= SYNAPTICS_Truly_AP2) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_Truly_AP2, MAX_IMAGE_NAME_LEN);
		}
		else if (tp_hw_run >= SYNAPTICS_AP2) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_AP2, MAX_IMAGE_NAME_LEN);
		}

		else if (tp_hw_run >= SYNAPTICS_AP1) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_AP1, MAX_IMAGE_NAME_LEN);
		}

		else if (tp_hw_run >= SYNAPTICS_I53_AP) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_I53_AP, MAX_IMAGE_NAME_LEN);
		}
		else if (tp_hw_run >= SYNAPTICS_SP) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_DP_SP, MAX_IMAGE_NAME_LEN);
		}
		else if (tp_hw_run >= SYNAPTICS_DP) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_DP_SP, MAX_IMAGE_NAME_LEN);
		}
/*[Lavender][bozhi_lin] 20150714 end*/
/*[SM20][zihweishen] 20151130 end*/
...
/*[SM20][zihweishen] 20160504 end*/
			...
			strncpy(fwu->image_name, "", MAX_IMAGE_NAME_LEN);
		}
#else
		if (tp_hw_run >= SYNAPTICS_SP) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_SP, MAX_IMAGE_NAME_LEN);
		}
		else if(tp_hw_run >= SYNAPTICS_DP) {
			strncpy(fwu->image_name, FW_IMAGE_NAME_DP, MAX_IMAGE_NAME_LEN);
		}
		else {
			strncpy(fwu->image_name, "", MAX_IMAGE_NAME_LEN);
		}
...
//[SM20][zihweishen] Patch for Security Incident SSIMS00001377 CVE-2016-6742 A-30799828 fix is designed to add additional bounds checks to prevent the potential heap overflow begin 2016/10/17
...
//[SM20][zihweishen] end 2016/10/17
