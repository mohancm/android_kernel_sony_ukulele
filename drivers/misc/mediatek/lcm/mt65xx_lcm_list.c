...
//<2015/11/26-stevenchen, Auto detect Truly+OTM1906A and Innolux+OTM1906A LCM
#if defined(OTM1906A_FHD_DSI_VDO_6INCH_TRULY)
    &otm1906a_fhd_dsi_vdo_6inch_truly_lcm_drv,
#endif
//>2015/11/26-stevenchen

//<2015/10/20-stevenchen, LCM driver porting
#if defined(OTM1906A_FHD_DSI_VDO_6INCH_INNOLUX)
    &otm1906a_fhd_dsi_vdo_6inch_innolux_lcm_drv,
#endif

#if defined(R63422_FHD_DSI_CMD_TRULY)
    &r63422_fhd_dsi_cmd_truly_lcm_drv,
#endif
//>2015/10/20-stevenchen
