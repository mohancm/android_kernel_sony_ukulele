...
{
//MTK start, add for catching the log of MTBF issue
unsigned int int_status_value = 0;
int_status_value = upmu_get_reg_value(0x212);
printk("[ldo_oc_int_handler][0x212] oc reg1 = %d\n",int_status_value );
int_status_value = upmu_get_reg_value(0x214);
printk("[ldo_oc_int_handler][0x214] oc reg2 = %d\n",int_status_value );
//MTK end

//<2016/04/07-stevenchen, SD OC(Over Current) detection.
	printk("[Steven] %s \n", __func__);
//>2016/04/07-stevenchen
...
//<2016/06/08-stevenchen, Remove OC interrupt detection
//<2016/04/07-stevenchen, SD OC(Over Current) detection.
	//pmic_register_interrupt_callback(31, ldo_oc_int_handler);
//>2016/04/07-stevenchen
//>2016/06/08-stevenchen
