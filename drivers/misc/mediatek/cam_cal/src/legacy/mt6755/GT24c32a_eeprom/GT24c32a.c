...
#define GT24C32A_DEVICE_ID	0xA0
...
static long gt24c32_Ioctl_Compat(struct file *filp, unsigned int cmd, unsigned long arg)
{
    ...
    stCAM_CAL_INFO_STRUCT __user *data;
    int err;
	  EEPROMDB("[CAMERA SENSOR] gt24c32_Ioctl_Compat,%p %p %x ioc size %d\n",filp->f_op ,filp->f_op->unlocked_ioctl,cmd,_IOC_SIZE(cmd) );
	...
	i4RetValue = EEPROM_Ioctl(filp, cmd, (unsigned long)compat_ptr(arg));
...
static inline int RegisterEEPROMCharDrv(void)
{
	...
	EEPROM_class = class_create(THIS_MODULE, "CAM_CALdrv");
...
/* //////////////////////////////////////////////////////////////////// */
#if 0 //<20151207 RickLiu MTK patch
...
static unsigned short force[] = {EEPROM_I2C_GROUP_ID, GT24C32A_DEVICE_ID, I2C_CLIENT_END,
	I2C_CLIENT_END};
#else
