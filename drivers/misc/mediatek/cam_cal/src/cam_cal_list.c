...
unsigned int mtkCidList[MTK_MAX_CID_NUM] = {
	0x0101ffff,/*Single MTK Format*/
	0x010b00ff,/*Double MTK Format in One OTP/EEPRom - Legacy*/
	0x030b00ff, /*Double MTK Format in One OTP/EEPRom*/
	0x02010000, //truly
	0x010cffff //new LiteOn
...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{IMX230_SENSOR_ID, 0xA0, CMD_GT24C32A, cam_cal_check_mtk_cid},
	{IMX230B_SENSOR_ID, 0xA0, CMD_GT24C32A, cam_cal_check_mtk_cid},//new LiteOn, Truly
	{IMX234_SENSOR_ID, 0xA2, CMD_AUTO, cam_cal_check_mtk_cid},
	/*  ADD before this line */
