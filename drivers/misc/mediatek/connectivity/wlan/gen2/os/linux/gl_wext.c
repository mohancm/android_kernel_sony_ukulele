...
//<2016/05/31-louisliu, Security Incident SSIMS00000859 and SSIMS00000863
#define COUNTRY_CODE_LEN 10 /*country code length */
//>2016/05/31-louisliu
...
*/
	...
	rStatus = kalIoctl(prGlueInfo, wlanoidSetCountryCode, &aucCountry[COUNTRY_CODE_LEN - 2], 2, FALSE, FALSE, TRUE, FALSE, &u4BufLen);
//>2016/05/31-louisliu
	if (rStatus != WLAN_STATUS_SUCCESS) {
