...
/*COMPAT IOCTLs for akm09916 device */
#define COMPAT_ECS_IOCTL_SET_YPR_09916         _IOW(MSENSOR, 0x29, compat_int_t[26])
#define COMPAT_ECS_IOCTL_GET_DELAY_09916       _IOR(MSENSOR, 0x30, int64_t[3])
#define	COMPAT_ECS_IOCTL_GET_LAYOUT_09916	   _IOR(MSENSOR, 0x31, char)
