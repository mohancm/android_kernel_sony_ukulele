...
#define MAINTENANCE_FIRST_STAGE_CV 4256000
#define MAINTENANCE_SECOND_STAGE_CV 4208000
// >>> 2016/03/14-youchihwang. Battery. Maintenance.
// >>> 2016/02/21-youchihwang. Battery. Maintenance.
...
// <<< 2016/02/21-youchihwang. Battery. Maintenance.
#define MAINTENANCE_FIRST_STAGE_TIME_LIMIT (60 * 60 * 60) // 60 hours
#define MAINTENANCE_SECOND_STAGE_TIME_LIMIT (260 * 60 * 60) // 260 hours
// <<< 2016/02/21-youchihwang. Battery. Maintenance.

// <<< 2016/02/13-youchihwang. Battery. Safety timer
#define    AC_CHARGING_TIMER     (5   * 60 * 60)      // 5 hours
#define    USB_CHARGING_TIMER    (100 * 60 * 60)    // 100 hours
// >>> 2016/02/13-youchihwang. Battery. Safety timer
/*****************************************************************************
 *  BATTERY Protection
 ****************************************************************************/
...
struct battery_custom_data {
	...
	int usb_charger_current;
        ...
        int usb_charger_battery_charging_current;
        // >>> 2016/03/06-youchihwang. Battery. Setting PC USB port charging parameters
