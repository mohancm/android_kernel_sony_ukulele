...
extern void read_imx230B_eeprom( void);
extern void read_imx230B_SPC( BYTE* data );
extern void read_eeprom_versionB( BYTE* data );
extern void read_imx230B_DCC( kal_uint16 addr,BYTE* data, kal_uint32 size);
