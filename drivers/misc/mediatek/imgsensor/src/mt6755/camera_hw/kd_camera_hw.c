...
PowerUp PowerOnList = {
	{
	 ...
	 {SENSOR_DRVNAME_OV8858_MIPI_RAW,
	  ...
	  {SENSOR_DRVNAME_IMX214_MIPI_RAW,
	  {
	   ...
	   //<2015/9/9-kylechang, Add Main Camera Driver IMX230
	   {SENSOR_DRVNAME_IMX230_MIPI_RAW,
		 {
		 {SensorMCLK, Vol_High, 0},
		 {DOVDD, Vol_1800, 0},
		 {AVDD, Vol_2800, 0},//{AVDD, Vol_2500, 0},
		 {DVDD, Vol_1100, 0},
		 {AFVDD, Vol_2800, 5},
		 {PDN, Vol_Low, 4},
		 {PDN, Vol_High, 0},
	   ...
	   //<2015/9/9-kylechang, Add Main Camera Driver IMX230B
	   {SENSOR_DRVNAME_IMX230B_MIPI_RAW,
		 {
		 {SensorMCLK, Vol_High, 0},
		 {DOVDD, Vol_1800, 0},
		 {AVDD, Vol_2800, 0},//{AVDD, Vol_2500, 0},
	   ...
	   //<2015/10/9-kylechang, Add Sub Camera Driver IMX234
	   //<2015/10/15-kylechang, Change power sequence
	   #if defined(IMX234_MIPI_RAW)
	   {SENSOR_DRVNAME_IMX234_MIPI_RAW,
		 {
		   //{SensorMCLK,Vol_High, 0},
		   {AVDD,  Vol_2800, 0},
		   {DOVDD, Vol_1800, 0},
...
//<2015/12/30-stevenchen, Turn OFF VLDO28 when camera AF is not used.
