...
//<2016/03/10-stevenchen, Distinguish Samsung 2G,3G and Hynix 3G memory.
//<2015/11/23-stevenchen, Create proc/emmc_vendor to show emmc vendor info.
...
static int proc_emmc_vendor_show(struct seq_file *m, void *v)
{
	...
	if(emmc_manfid == SAMSUNG_EMMC_CHIP)
	{
		if(emmc_product_name == SAMSUNG_2G_PRODUCT_NAME)
			seq_printf(m, "Samsung KMQ310013M,16GB+2GB\n");   
		else      
			seq_printf(m, "Samsung KMR31000BA_B614,16GB+3GB\n"); 
	}
	else
	{
		seq_printf(m, "Hynix H9TQ17ADFTACUR_KUM,16GB+3GB\n");          
	}
...
//>2015/11/23-stevenchen
//>2016/03/10-stevenchen
