...
static void store_cdrom_address(u8 *dest, int msf, u32 addr)
{
	if (msf) {
		...
		//addr >>= 2;		/* Convert to 2048-byte frames */	//Thunder modification for mount cdrom on MAC
...
{
	//Thunder modification for mount cdrom on MAC Start
	//int i, len;
	int len;
	int offset;
	//Thunder modification for mount cdrom on MAC End
